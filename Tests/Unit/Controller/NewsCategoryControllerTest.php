...
/**
 * Test case for class Tx_Customnewstagcloud_Controller_NewsCategoryController.
 *
 * @version $Id$
 ...
 */
class NewsCategoryControllerTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var 
	 */
	protected $fixture;
